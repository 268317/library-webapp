...
const LibrarianSortableAllBookTable: React.FC<SortableBookTableProps> = ({ books }) => {
                ...
                <TableBody>
                    {sortedBooks.map((book) => (
                        <TableRow key={book.id}>
                            ...
                            <TableCell>
                                <Button variant="contained" color="primary" onClick={() => console.log("Delete")}>
                                    Delete
                                </Button>
...
export default LibrarianSortableAllBookTable;
