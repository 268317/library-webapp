...
import LibrarianDrawerMenu from '../librarian/LibrarianDrawerMenu';
import LibrarianSortableAllBookTable from '../librarian/LibrarianSortableAllBookTable';
...
const ReaderHomePage: React.FC = () => {
    ...
    return (
        <div>
            ...
            <LibrarianDrawerMenu open={drawerOpen} onClose={toggleDrawer} />
            <div style={{ padding: '20px' }}>
                <Typography variant="h4" gutterBottom>Book List</Typography>
                <LibrarianSortableAllBookTable books={filteredBooks} />
            </div>
            <BottomFooter />
        </div>
    );
