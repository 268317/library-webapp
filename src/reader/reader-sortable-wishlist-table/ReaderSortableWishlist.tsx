...
const ReaderSortableWishlist: React.FC<SortableBookTableProps> = ({ books }) => {
                ...
                <TableBody>
                    {sortedBooks.map((book) => (
                        <TableRow key={book.id}>
                            ...
                            <TableCell>
                                <Button variant="outlined" onClick={() => console.log("Rent")}>
                                    Rent
                                </Button>
                            </TableCell>
                        </TableRow>
...
export default ReaderSortableWishlist;
