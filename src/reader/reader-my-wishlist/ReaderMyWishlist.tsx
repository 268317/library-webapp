...
import ReaderSortableWishlist from '../reader-sortable-wishlist-table/ReaderSortableWishlist';
...
const ReaderMyWishlist: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div style={{ padding: '20px' }}>
                <Typography variant="h4" gutterBottom>Wish List</Typography>
                <ReaderSortableWishlist books={filteredBooks} />
            </div>
            <BottomFooter />
        </div>
    );
...
export default ReaderMyWishlist;
