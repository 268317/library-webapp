...
const ReaderSortableAllBookTable: React.FC<SortableBookTableProps> = ({ books }) => {
                    ...
                    {sortedBooks.map((book) => (
                        <TableRow key={book.id}>
                            ...
                            <TableCell>
                                ...
                                <Button variant="outlined" onClick={() => console.log("See reviews")}>
                                    See reviews
                                </Button>
                                <IconButton color="primary" onClick={() => console.log("Add to wishlist")}>
                                    <FavoriteBorderIcon />
                                </IconButton>
                            </TableCell>
                        </TableRow>
...
export default ReaderSortableAllBookTable;
